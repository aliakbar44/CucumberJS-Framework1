...
module.exports = function() {
    ...
    this.When(/^I enter the wrong "([^"]*)" in email ID field$/, function (arg1) {

        this.driver.findElement({ id:'input-email'}).sendKeys(arg1)
    });
    this.When(/^I enter the wrong "([^"]*)" in password field$/, function (arg1) {
    ...
    this.Given(/^I verify the title of the application$/, function () {

        this.driver.getTitle().then(function (ele) {
            var title = ele;
    ...
    this.Then(/^I should see the "([^"]*)"$/, function (arg1) {
